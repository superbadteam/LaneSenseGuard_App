...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      //   label: 'Pages',
      //   route: '#',
      //   children: [{ label: 'Settings', route: '/profiles/settings' }]
      // }
    ]
  },
  // {
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/" class="flex items-center">
        <img class="w-16" src="/assets/img/logo.png" alt="Logo" />
        <h1>
          <span class="text-3xl font-semibold text-white">Safe</span>
          <span class="text-3xl font-semibold text-primary">Surf</span>
        </h1>
      </router-link>
