...
<template>
  <div>
    <label class="mb-3 block text-base font-medium text-black dark:text-white">
      {{ label }}
    </label>
    <div class="relative z-20 bg-white dark:bg-form-input">
      ...
      >
        ...
        <option :value="option" v-for="option in options" :key="option.value" class="text-body dark:text-bodydark">
            {{ option.text }}
        </option>
      </select>
